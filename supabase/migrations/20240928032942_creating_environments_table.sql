...
CREATE UNIQUE INDEX environments_display_key ON public.environments USING btree (display);
...
alter table "public"."environments" add constraint "environments_display_key" UNIQUE using index "environments_display_key";
